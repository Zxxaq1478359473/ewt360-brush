...
# -*- coding: utf-8 -*-
"""
EWT360 傻瓜式刷课引导器 - 【V3测试版】（ewt_brush_easy_v3_test.py）
=============================================
...
依赖：ewt_brush_v3_test.py 放在同目录（v3-test 测试版引擎）。
用法：python3 ewt_brush_easy_v3_test.py
...
BRUSH_SCRIPT = os.path.join(SCRIPT_DIR, "ewt_brush_v3_test.py")
...
def main():
    cprint("=" * 60)
    cprint("  🚀 EWT360 傻瓜式刷课工具 v3-test（测试版）")
