...
# -*- coding: utf-8 -*-
"""
EWT360 傻瓜式刷课引导器（ewt_brush_easy.py）
=============================================
...
依赖：ewt_brush_v2.py（或 ewt_brush_all_in_one.py）放在同目录。
用法：python3 ewt_brush_easy.py
"""
import json
import os
import subprocess
...
BRUSH_SCRIPT = os.path.join(SCRIPT_DIR, "ewt_brush_v2.py")
if not os.path.exists(BRUSH_SCRIPT):
    BRUSH_SCRIPT = os.path.join(SCRIPT_DIR, "ewt_brush_all_in_one.py")
